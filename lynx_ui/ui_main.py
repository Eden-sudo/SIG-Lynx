...
class LynxApp(ctk.CTk):
    def __init__(self):
        ...
        self.btn_nav_config = ctk.CTkButton(self.frame_sidebar, text="⚙️ Configuración", fg_color="transparent", border_width=2, text_color=("gray10", "#DCE4EE"), command=lambda: self.seleccionar_frame("config"))
        ...
        # 4. Consola Global (Siempre visible en la parte inferior del menú lateral o central)
        ...
        self.frame_sidebar.grid_rowconfigure(4, weight=1) # Empuja la consola hacia abajo
        ...
        self.frame_process = ProcessView(self, self.process_manager, self.log, corner_radius=0, fg_color="transparent")
    ...
    def seleccionar_frame(self, nombre_frame):
        ...
        # Mostrar el frame solicitado y pintar su botón
